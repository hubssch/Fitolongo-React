...
export default function UserRegistration({ onBack }) {
    ...
    return (
        <div className="p-6 max-w-md mx-auto bg-white dark:bg-gray-800 rounded shadow-md">
            ...
            <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Rejestracja Użytkownika</h1>
